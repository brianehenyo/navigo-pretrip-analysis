...
```{r}
skewness(pc.data.hl$raw.gcos.auto)
skewness(pc.data.hl$raw.gcos.cont)
skewness(pc.data.hl$raw.gcos.impe)
skewness(pc.data.hl$raw.mvs.intrinsic)
skewness(pc.data.hl$raw.mvs.integrated)
skewness(pc.data.hl$raw.mvs.identified)
skewness(pc.data.hl$raw.mvs.introjected)
skewness(pc.data.hl$raw.mvs.external)
skewness(pc.data.hl$raw.mvs.amotivation)
```

## Parametric Tests

MVS Intrinsic subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.intrinsic, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.intrinsic), sd=sd(pc.data.hl$raw.mvs.intrinsic)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.intrinsic)
shapiro.test(pc.data.hl$raw.mvs.intrinsic)
```
MVS Integrated subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.integrated, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.integrated), sd=sd(pc.data.hl$raw.mvs.integrated)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.integrated)
shapiro.test(pc.data.hl$raw.mvs.integrated)
```

MVS Identified subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.identified, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.identified), sd=sd(pc.data.hl$raw.mvs.identified)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.identified)
shapiro.test(pc.data.hl$raw.mvs.identified)
```

MVS Introjected subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.introjected, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.introjected), sd=sd(pc.data.hl$raw.mvs.introjected)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.introjected)
shapiro.test(pc.data.hl$raw.mvs.introjected)
```

MVS External subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.external, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.external), sd=sd(pc.data.hl$raw.mvs.external)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.external)
shapiro.test(pc.data.hl$raw.mvs.external)
```

MVS Amotivation subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.mvs.amotivation, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.mvs.amotivation), sd=sd(pc.data.hl$raw.mvs.amotivation)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.mvs.amotivation)
shapiro.test(pc.data.hl$raw.mvs.amotivation)
```

GCOS Autonomous subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.gcos.auto, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.gcos.auto), sd=sd(pc.data.hl$raw.gcos.auto)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.gcos.auto)
shapiro.test(pc.data.hl$raw.gcos.auto)
```

GCOS Controlled subscale scores are NOT normally distributed --> p-value is less than 0.05 thus the null hypothesis that it is normally distributed is rejected.

```{r}
hist(pc.data.hl$raw.gcos.cont, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.gcos.cont), sd=sd(pc.data.hl$raw.gcos.cont)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.gcos.cont)
shapiro.test(pc.data.hl$raw.gcos.cont)
```

GCOS Impersonal subscale scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.gcos.impe, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.gcos.impe), sd=sd(pc.data.hl$raw.gcos.impe)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.gcos.impe)
shapiro.test(pc.data.hl$raw.gcos.impe)
```

Autonomous motivation scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.auto.motivation, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.auto.motivation), sd=sd(pc.data.hl$raw.auto.motivation)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.auto.motivation)
shapiro.test(pc.data.hl$raw.auto.motivation)
```

Controlled motivation scores are normally distributed --> p-value is greater than 0.05 thus the null hypothesis that it is normally distributed is NOT rejected.

```{r}
hist(pc.data.hl$raw.cont.motivation, col="red", xlim=c(1,7), prob=TRUE)
x <- seq(1,7,0.1)
curve(dnorm(x,mean=mean(pc.data.hl$raw.cont.motivation), sd=sd(pc.data.hl$raw.cont.motivation)), 1, 7, col="blue", add=TRUE)
stat.desc(pc.data.hl$raw.cont.motivation)
shapiro.test(pc.data.hl$raw.cont.motivation)
```

## Correlation of SDT constructs

```{r}
pc.data.hl.raw <- pc.data.hl %>% 
  select(raw.gcos.auto, raw.gcos.cont, raw.gcos.impe, raw.mvs.intrinsic, raw.mvs.integrated, raw.mvs.identified, raw.mvs.introjected, raw.mvs.external, raw.mvs.amotivation)

sdt.corr <- rcorr(as.matrix(pc.data.hl.raw))
sdt.corr
```
...
## Most Preferred Versions

```{r}
data.winners <- tibble(winner = c("FR","CP","CR","CR","VR","FR","VR","VP","FR","CP","CR","FP","FR","FR","CR","VR","BL","FR","FR","CR","VR","FR","FR","BL","CP","FR","CP","CR","CR","CP","VP","VP","FR","FR","VP","FP"))

data.winners %>% 
  mutate(winner = factor(winner, levels = c("CP", "VP", "FP", "CR", "VR", "FR", "BL"))) %>% 
  ggplot(aes(winner)) +
  geom_bar(aes(fill = winner)) + 
  scale_fill_manual(values=condition.colors, guide = FALSE) +
  labs(x = "",
       y = "# of participants who preferred") +
  scale_y_continuous(breaks = seq(0, 12, by = 2), limits = c(0, 12)) +
  coord_flip() +
  theme_tufte(base_family = "Arial", ticks = FALSE)

ggsave("output/pc-winners.png", width=4, height=4)
```
